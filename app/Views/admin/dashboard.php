...
<html lang="en">
  <head>
	...
	<link href="../public/admin/assets/fullcalendar/fullcalendar/fullcalendar.css" rel="stylesheet" />
	...
	<link href="../public/admin/css/jquery-jvectormap-1.2.2.css" rel="stylesheet">
	<link rel="stylesheet" href="../public/admin/css/fullcalendar.css">
	<link href="../public/admin/css/widgets.css" rel="stylesheet">
    <link href="../public/admin/css/style.css" rel="stylesheet">
    <link href="../public/admin/css/style-responsive.css" rel="stylesheet" />
	<link href="../public/admin/css/xcharts.min.css" rel=" stylesheet">	
	<link href="../public/admin/css/jquery-ui-1.10.4.min.css" rel="stylesheet">
  ...
  <!-- container section start -->
    ...
    <script type="text/javascript" src="../public/admin/js/jquery-ui-1.9.2.custom.min.js"></script>
    <!-- bootstrap -->
	...
	<script src="../public/admin/assets/fullcalendar/fullcalendar/fullcalendar.js"></script>
    <!--script for this page only-->
    <script src="../public/admin/js/calendar-custom.js"></script>
	<script src="../public/admin/js/jquery.rateit.min.js"></script>
    <!-- custom select -->
    <script src="../public/admin/js/jquery.customSelect.min.js" ></script>
	<script src="../public/admin/assets/chart-master/Chart.js"></script>
	...
	<script src="../public/admin/js/xcharts.min.js"></script>
	<script src="../public/admin/js/jquery.autosize.min.js"></script>
	<script src="../public/admin/js/jquery.placeholder.min.js"></script>
	<script src="../public/admin/js/gdp-data.js"></script>	
	<script src="../public/admin/js/morris.min.js"></script>
	<script src="../public/admin/js/sparklines.js"></script>	
	<script src="../public/admin/js/charts.js"></script>
